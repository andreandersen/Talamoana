...
namespace Talamoana.Domain.Core.Modifiers
{
    ...
    public interface IModifier : IEquatable<IModifier>
    {
        ...
        /// </summary>
        IReadOnlyList<TagWeight> SpawnWeights { get; }

        /// <summary>
        ///     Weight factor when tag is present from previously added modifiers.
        /// </summary>
        IReadOnlyList<TagWeight> GenerationWeights { get; }
    }
}