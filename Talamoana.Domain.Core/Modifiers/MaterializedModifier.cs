...
namespace Talamoana.Domain.Core.Modifiers
{
    ...
    {
        private readonly Dictionary<IStat, int> _values;
        ...
        internal MaterializedModifier(IModifier modifier, Dictionary<IStat, int> values)
        {
        ...
        /// <inheritdoc />
        public IReadOnlyDictionary<IStat, int> Values => _values;
